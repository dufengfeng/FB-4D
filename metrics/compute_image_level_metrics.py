...
# Load the CLIP model
model_ID = "huggingface/hub/models--openai--clip-vit-base-patch32/snapshots/e6a30b603a447e251fdaca1c3056b2a16cdfebeb/"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_file', type=str, default='./result_image4_level.json', help='output')
    ...
    for eval_object in gt_objects:
        ...
        object_clip = object_clip / eval_views
        object_lpip = object_lpip / eval_views
        object_ssim = object_ssim / eval_views
        object_psnr = object_psnr / eval_views
