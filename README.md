...
***Test dataset*** can be downloaded from [Consistent4D](https://github.com/yanqinJiang/Consistent4D)
...
```
We use the Consistent4D to do evaluation. To evaluate, first transform rgba gt images to images with white background. Download the pre-trained model i3d_pretrained_400.pt as [Consistent4D](https://github.com/yanqinJiang/Consistent4D) detailed for calculating FVD. Organize the reuslt folder as follows:
```
├── eval_dataset
      | gt
      │   ├── object_0
